...
const Contact = () => {
    ...
    <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[3rem]">
        ...
        >
            ...
            <h1 className="text-center  w-[90%] xl:w-[70%] tracking-[0.1rem] mx-auto font-bold text-[20px] md:text-
            [30px] text-black">
                Get special offer and more from Traveller
            </h1>
            ...
            <div className="flex  mt-[1.4rem] rounded-lg bg-gray-300  mb-[3rem] items-center space-x-2 w-[80%] h-[4vh]
             md:h=[6.3vh]">
                <input
