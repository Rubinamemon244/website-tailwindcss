        ...
        ">
            <div className="flex items-center justify-center flex-col w-[100%] h-[100%]">
                <div data-aos="fade-right">
                    <h1 className="text-[25px] mb-[1rem] md:mb-[0] text-center md:text-[35px] lg:text-[45px] tracking-[0.
                    7rem] text-white font-bold [word-spacing:5px]">
                        Lets Enjoy The Journey
                    </h1>
                    <p className="md:text-[16px] text-center text-[18px] text-white font-normal [word-spacing:5px]">
                        Get the best tour experience with us and explore the world
                    </p>
                </div>
                < SearchBox />
                <a 
                ...
                >
                    <span className="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform-x-12
